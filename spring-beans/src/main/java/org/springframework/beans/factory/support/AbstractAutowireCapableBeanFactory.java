...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Object doCreateBean(final String beanName, final RootBeanDefinition mbd, final @Nullable Object[] args)
        ...
        if (earlySingletonExposure) {
            ...
            // 将bean的半成品的创建流程封装在ObjectFactory中，再发生循环引用的时候，可以提前拿到提早暴露的bean的半成品
         ...
         * 所以需要从earlySingletonObjects中拿到增强后的bean赋值给exposedObject。
         *
         * **/
    ...
    protected Class<?> getTypeForFactoryMethod(String beanName, RootBeanDefinition mbd, Class<?>... typesToMatch) {
        ...
        cachedReturnType =
                (uniqueCandidate != null ? ResolvableType.forMethodReturnType(uniqueCandidate) : ResolvableType.forClass(commonType));
    ...
    protected BeanWrapper createBeanInstance(String beanName, RootBeanDefinition mbd, @Nullable Object[] args) {
        ...
        if (mbd.getFactoryMethodName() != null) {
        	//@Configuration class中定义的@Bean，要使用factory method进行实例化
		...
		// 用后置处理器AutowiredAnnotationBeanPostProcessor决定可用于实例化的构造函数候选人
		//
    ...
    protected BeanWrapper instantiateBean(final String beanName, final RootBeanDefinition mbd) {
        try {
            ...
            // 注册PropertyEditor和ConversionService到bw
            initBeanWrapper(bw);
            return bw;
        } catch (Throwable ex) {
    ...
    protected void populateBean(String beanName, RootBeanDefinition mbd, @Nullable BeanWrapper bw) {
        ...
        //不管是AUTOWIRE_BY_NAME还是AUTOWIRE_BY_TYPE都是在进行自动注入
    ...
    protected void autowireByName(String beanName, AbstractBeanDefinition mbd, BeanWrapper bw, MutablePropertyValues pvs) {
        ...
        for (String propertyName : propertyNames) {
            if (containsBean(propertyName)) {
                ...
                if (logger.isTraceEnabled()) {
                    logger.trace("Added autowiring by name from bean name '" + beanName + "' via property '" + propertyName
            ...
            try {
                ...
                if (Object.class != pd.getPropertyType()) {
                    ...
                    for (String autowiredBeanName : autowiredBeanNames) {
                        ...
                        if (logger.isTraceEnabled()) {
                            logger.trace("Autowiring by type from bean name '" + beanName + "' via property '" + propertyName
     ...
     */
    protected void checkDependencies(String beanName, AbstractBeanDefinition mbd, PropertyDescriptor[] pds, @Nullable PropertyValues pvs)
